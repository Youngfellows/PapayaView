...
public class LoveCircleView extends View {
    ...
    public LoveCircleView(Context context) {
        super(context);
        init();
    }

    public LoveCircleView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public LoveCircleView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        //初始化贝塞尔圆相关
        mCircleRadius = Math.min(getWidth(), getHeight()) / 6;//圆的半径
